...
const DEFAULT_SUPABASE_URL = "https://ioxwmfqiefbernhprfuy.supabase.co";
const DEFAULT_ANON_KEY = "sb_publishable_GuLJyXmpETfuERfM8fIRng_Nz_GOVe1";
...
function getAdminClient(): SupabaseClient {
  ...
  const anonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || process.env.SUPABASE_ANON_KEY || DEFAULT_ANON_KEY;
