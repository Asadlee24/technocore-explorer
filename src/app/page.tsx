...
import { ContinuumLiveStats } from "@/components/overview/ContinuumLiveStats";
...
export default async function HomePage() {
  const [overview, discoveryEvents, lobbyMessages, liveStats] = await Promise.all([
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      {/* Prominent Live Continuum Archival Metrics (Real Supabase Live Counts) */}
      <section>
        <ContinuumLiveStats initialStats={liveStats} />
      </section>

      {/* Real-time Metric Cards (Protocol Network Vital Signs) */}
